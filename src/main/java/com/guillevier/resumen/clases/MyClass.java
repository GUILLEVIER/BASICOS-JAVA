...
Puede ser llamado directamente en la interfaz sin instanciarla. Al ejecutar este código, se imprimirá "Hello from MyInterface static method".
*/
public class MyClass implements MyInterface {
  ...
  Este método no puede ser llamado directamente desde otras clases.
