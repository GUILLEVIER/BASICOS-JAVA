...
public class OperadorInstanceOfTiposGenericos {
  public static void main(String[] args) {
    ...
    System.out.println("num es del tipo Number = " + b1); // true
    b1 = num instanceof Object;
    System.out.println("num es del tipo Object = " + b1); // true
    ...
    System.out.println("decimal es del tipo Double = " + b1); // false
    b1 = decimal instanceof Float;
    System.out.println("decimal es del tipo Float = " + b1); // true
    b1 = decimal instanceof Integer;
    System.out.println("decimal es del tipo Integer = " + b1); // false
    b1 = decimal instanceof Number;
    System.out.println("decimal es del tipo Number = " + b1); // true
